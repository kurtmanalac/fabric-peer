...
RUN wget https://github.com/hyperledger/fabric-ca/releases/download/v1.5/hyperledger-fabric-ca-linux-amd64-1.5.tar.gz && \
    tar -xzf hyperledger-fabric-ca-linux-amd64-1.5.tar.gz && \
